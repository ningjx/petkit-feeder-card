...
`;async function Pe(e,t,i="Button"){try{await e.callService("button","press",{entity_id:t})}catch(e){console.error(`[PetkitFeeder] ${i}失败:`,e)}}class Te{_editingItem=null;_originalItemData=null;get editingItem(){return this._editingItem}get originalItemData(){return this._originalItemData}get isEditing(){return null!==this._editingItem}startEdit(e,t,i,s,n,a,o,r){this._editingItem={itemId:e,field:t,time:i,name:s,amount:n},this._originalItemData={time:a,name:o,amount:r}}updateEditData(e,t,i){this._editingItem&&(void 0!==e&&(this._editingItem.time=e),void 0!==t&&(this._editingItem.name=t),void 0!==i&&(this._editingItem.amount=i))}cancelEdit(){this._editingItem=null,this._originalItemData=null}completeEdit(){this._editingItem=null,this._originalItemData=null}}function ze(e,t){const i=new Map,s=new Map;e.filter(e=>"plan"===e.itemType).forEach(e=>{i.set(e.itemId,e)}),t.filter(e=>"plan"===e.itemType).forEach(e=>{s.set(e.itemId,e)});const n={added:[],modified:[],deleted:[]};return s.forEach((e,t)=>{const s=i.get(t);s?function(e,t){return e.time!==t.time||e.name!==t.name||e.plannedAmount!==t.plannedAmount||e.isEnabled!==t.isEnabled}(s,e)&&n.modified.push(e):n.added.push(e)}),i.forEach((e,t)=>{s.has(t)||n.deleted.push(t)}),0===n.added.length&&0===n.modified.length&&0===n.deleted.length?null:n}class Oe{_originData=null;_cacheData=null;get originData(){return this._originData}initOrigin(e){this._originData=this._deepClone(e),this._cacheData=this._deepClone(e)}getDayCache(e){return this._cacheData?.days.get(e)||null}rollback(){this._originData&&(this._cacheData=this._deepClone(this._originData))}commit(){this._cacheData&&(this._originData=this._deepClone(this._cacheData))}detectChanges(){if(!this._originData||!this._cacheData)return[];const e=[];for(let t=1;t<=7;t++){const i=this._originData.days.get(t),s=this._cacheData.days.get(t);if(!i||!s)continue;ze(i.timeline,s.timeline)&&e.push({day:t,items:s.timeline.filter(e=>"plan"===e.itemType).map(e=>({time:e.time,amount:e.plannedAmount,name:e.name,enabled:e.isEnabled}))})}return e}_deepClone(e){const t=new Map;return e.days.forEach((e,i)=>{t.set(i,{...e,timeline:this._deepCloneTimeline(e.timeline),summary:{...e.summary}})}),{days:t,lastUpdated:e.lastUpdated}}_deepCloneTimeline(e){return e.map(e=>({...e}))}}let Ue=class extends le{hass;_config;_weeklyCache=new Oe;_editState=new Te;_selectedDay=1;_isOnline=!0;_saveDebounceTimer=null;_isSaving=!1;_pendingFocus=null;_isInEditMode=!1;_togglingItemIds=new Set;_getEntityId(e){return this._config?function(e,t){const i=e.device_id;return i?`sensor.petkit_feeder_${i}_${t}`:e.entity||""}(this._config,e):""}static getStubConfig(){return{device_id:"",show_timeline:!0,show_summary:!0,show_actions:!0}}static getConfigElement(){return document.createElement("petkit-feeder-card-editor")}setConfig(e){if(!e.device_id&&!e.entity)throw new Error(Ae("error.device_or_entity_required"));this._config={...e,show_timeline:e.show_timeline??!0,show_summary:e.show_summary??!0,show_actions:e.show_actions??!0}}shouldUpdate(){return!0}updated(){if(this._pendingFocus){const{itemId:e,field:t}=this._pendingFocus,i=`edit-${t}-${e}`,s=this.shadowRoot?.getElementById(i);s&&(s.focus(),"name"===t?s.select():"time"===t&&s.showPicker?.()),this._isInEditMode=!1,this._pendingFocus=null}}render(){if(!this._config||!this.hass)return B`<div>${this._localize("common.loading")}</div>`;const e=this._config.entity||this._getEntityId("feeding_schedule"),t=this._config.history_entity||this._getEntityId("feeding_records"),i=this.hass.states[e],s=t?this.hass.states[t]:null;if(!i)return B`
      ...
      `;const n=(a=this._config).connectivity_entity||`binary_sensor.petkit_feeder_${a.device_id}_online`;var a;const o=this.hass.states[n],r="on"===o?.state;this._isOnline=r;const d=Ee(this.hass),l=Se(i.attributes,s?.attributes||{},r,d);this._weeklyCache.originData||(this._weeklyCache.initOrigin(l),this._selectedDay=_e());const c=this._weeklyCache.getDayCache(this._selectedDay),h=c?.timeline||[],u=c?.summary||{planAmount:0,actualAmount:0,manualAmount:0,isOnline:!1,totalCount:0,completedCount:0,pendingCount:0};let p=this._config.name;if(!p){const e=this._config.device_name_entity||this._getEntityId("device_name"),t=this.hass.states[e];p=t?.state}return p||(p=i.attributes.friendly_name||this._localize("default.device_name")),B`
    ...
    `:B`
      ...
      `}_renderTimelineItem(e,t){const i=this._editState.editingItem,s=i?.itemId===e.itemId?i?.field:null,n=function(e,t){const i=_e();if(t<i)return!0;if(t!==i||!e.time)return!1;const s=new Date,n=60*s.getHours()+s.getMinutes(),[a,o]=e.time.split(":").map(Number);return 60*a+o<n}(e,this._selectedDay),a=t&&"plan"===e.itemType&&e.canDisable&&!n,o=t&&"plan"===e.itemType&&e.canDelete,r=t&&"plan"===e.itemType,d="time"===s&&i?B`
          <input
          ...
          />
        `:B`<span class="time ${r?"editable":""}" @click=${r?()=>this._startEdit(e,"time"):void 0}>${e.time}</span>`,l="name"===s&&i?B`
          <input
...
`)();_localize(e,t){return Ae(e,Ee(this.hass),t)}};e([me({attribute:!1})],Ue.prototype,"hass",void 0),e([me({attribute:!1})],Ue.prototype,"_config",void 0),Ue=e([he("petkit-feeder-card")],Ue),customElements.get("petkit-feeder-card")||customElements.define("petkit-feeder-card",Ue);let Me=class extends le{hass;config;_schema=[{name:"device_id",required:!1,selector:{text:{}},label:"editor.device_id"},{name:"entity",required:!1,selector:{entity:{domain:["sensor"]}},label:"editor.entity"},{name:"history_entity",required:!1,selector:{entity:{domain:["sensor"]}},label:"editor.history_entity"},{name:"name",selector:{text:{}},label:"editor.card_title"},{type:"grid",name:"",title:"editor.display_control",schema:[{name:"show_timeline",selector:{boolean:{}},label:"editor.show_timeline"},{name:"show_summary",selector:{boolean:{}},label:"editor.show_summary"},{name:"show_actions",selector:{boolean:{}},label:"editor.show_actions"}]}];render(){return this.hass&&this.config?B`
      ...
      ></ha-form>
    `:B`<div>${this._localize("common.loading_editor")}</div>`}_computeLabel=e=>this._localize(e.name||e.label||e.title);_valueChanged(e){const t=e.detail.value;this.config=t;const i=new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0});this.dispatchEvent(i)}_localize(e){return Ae(e,Ee(this.hass||{}))}static get styles(){return o`
      :host {
        display: block;
      }
      ha-form {
    ...
    `}};e([me()],Me.prototype,"hass",void 0),e([me()],Me.prototype,"config",void 0),Me=e([he("petkit-feeder-card-editor")],Me),customElements.get("petkit-feeder-card-editor")||customElements.define("petkit-feeder-card-editor",Me),window.customCards=window.customCards||[],window.customCards.push({type:"petkit-feeder-card",name:"Petkit Feeder Card",description:"Display Petkit feeder status, feeding schedule and history",preview:!0,documentationURL:"https://github.com/ningjx/petkit-feeder-card"});export{Ue as PetkitFeederCard,Me as PetkitFeederCardEditor};
