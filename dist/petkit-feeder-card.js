...
`;function Se(e,t){const i=new Map,s=new Map;e.filter(e=>"plan"===e.itemType).forEach(e=>{i.set(e.itemId,e)}),t.filter(e=>"plan"===e.itemType).forEach(e=>{s.set(e.itemId,e)});const n={added:[],modified:[],deleted:[]};return s.forEach((e,t)=>{const s=i.get(t);s?function(e,t){return e.time!==t.time||e.name!==t.name||e.plannedAmount!==t.plannedAmount||e.isEnabled!==t.isEnabled}(s,e)&&n.modified.push(e):n.added.push(e)}),i.forEach((e,t)=>{s.has(t)||n.deleted.push(t)}),0===n.added.length&&0===n.modified.length&&0===n.deleted.length?null:n}class Ce{_originData=null;_cacheData=null;get originData(){return this._originData}get cacheData(){return this._cacheData}initOrigin(e){this._originData=this._deepClone(e),this._cacheData=this._deepClone(e)}cloneToCache(){this._originData&&(this._cacheData=this._deepClone(this._originData))}updateDayTimeline(e,t){if(!this._cacheData)return;const i=this._cacheData.days.get(e);i&&(i.timeline=this._deepCloneTimeline(t))}getDayCache(e){return this._cacheData?.days.get(e)||null}getDayOrigin(e){return this._originData?.days.get(e)||null}rollback(){this._originData&&(this._cacheData=this._deepClone(this._originData))}commit(){this._cacheData&&(this._originData=this._deepClone(this._cacheData))}detectChanges(){if(!this._originData||!this._cacheData)return[];const e=[];for(let t=1;t<=7;t++){const i=this._originData.days.get(t),s=this._cacheData.days.get(t);if(!i||!s)continue;Se(i.timeline,s.timeline)&&e.push({day:t,items:s.timeline.filter(e=>"plan"===e.itemType).map(e=>({time:e.time,amount:e.plannedAmount,name:e.name,enabled:e.isEnabled}))})}return e}hasChanges(){return this.detectChanges().length>0}clear(){this._originData=null,this._cacheData=null}_deepClone(e){const t=new Map;return e.days.forEach((e,i)=>{t.set(i,{...e,timeline:this._deepCloneTimeline(e.timeline),summary:{...e.summary}})}),{days:t,lastUpdated:e.lastUpdated}}_deepCloneTimeline(e){return e.map(e=>({...e}))}}const Te={zh:{"common.loading":"加载中...","common.loading_editor":"正在加载...","error.entity_not_found":"实体不存在：{entityId}","error.device_or_entity_required":"需要定义 device_id 或 entity","button.refresh":"刷新数据","button.manual_feed":"手动喂食","button.add_plan":"新增计划","button.delete_plan":"删除计划","status.online":"在线","status.offline":"离线","status.executed":"已执行","status.expired":"已过期","status.deleted":"已删除计划","status.click_enable":"点击启用","status.click_disable":"点击禁用","summary.online_status":"在线状态","summary.planned_feed":"计划喂食","summary.actual_feed":"实际喂食","summary.manual_feed":"手动喂食","editor.device_id":"设备ID","editor.entity":"喂食计划实体","editor.entity_hint":"（可选，提供 device_id 时自动推断）","editor.history_entity":"历史记录实体","editor.card_title":"卡片标题","editor.card_title_hint":"（可选，默认使用设备名称）","editor.display_control":"显示控制","editor.show_timeline":"显示时间线","editor.show_summary":"显示统计","editor.show_actions":"显示操作按钮","weekday.1":"周一","weekday.2":"周二","weekday.3":"周三","weekday.4":"周四","weekday.5":"周五","weekday.6":"周六","weekday.7":"周日","date.format":"{month}月{day}日 {weekday}","timeline.empty":"暂无喂食计划","default.plan_name":"早餐","default.device_name":"小佩喂食器","placeholder.name":"名称"},en:{"common.loading":"Loading...","common.loading_editor":"Loading...","error.entity_not_found":"Entity not found: {entityId}","error.device_or_entity_required":"device_id or entity is required","button.refresh":"Refresh","button.manual_feed":"Manual Feed","button.add_plan":"Add Plan","button.delete_plan":"Delete Plan","status.online":"Online","status.offline":"Offline","status.executed":"Executed","status.expired":"Expired","status.deleted":"Deleted Plan","status.click_enable":"Click to enable","status.click_disable":"Click to disable","summary.online_status":"Online Status","summary.planned_feed":"Planned Feed","summary.actual_feed":"Actual Feed","summary.manual_feed":"Manual Feed","editor.device_id":"Device ID","editor.entity":"Feeding Schedule Entity","editor.entity_hint":"(optional, auto-detected if device_id provided)","editor.history_entity":"History Entity","editor.card_title":"Card Title","editor.card_title_hint":"(optional, defaults to device name)","editor.display_control":"Display Options","editor.show_timeline":"Show Timeline","editor.show_summary":"Show Summary","editor.show_actions":"Show Action Buttons","weekday.1":"Mon","weekday.2":"Tue","weekday.3":"Wed","weekday.4":"Thu","weekday.5":"Fri","weekday.6":"Sat","weekday.7":"Sun","date.format":"{weekday} {month}/{day}","timeline.empty":"No feeding plans","default.plan_name":"Breakfast","default.device_name":"Petkit Feeder","placeholder.name":"Name"}},Ie="zh";function Pe(e,t=Ie,i){let s=Te[t]?.[e]||Te[Ie]?.[e]||e;return i&&Object.entries(i).forEach(([e,t])=>{s=s.replace(`{${e}}`,String(t))}),s}function ze(e){const t=e?.locale?.language||Ie;return t.startsWith("zh")?"zh":Te[t]?t:Ie}let Ue=class extends de{hass;_config;_weeklyCache=new Ce;_selectedDay=1;_editingItem=null;_originalItemData=null;_saveDebounceTimer=null;_isSaving=!1;_pendingFocus=null;_isAddingNewPlan=!1;_isTogglingItem=!1;_getEntityId(e){return this._config?function(e,t){const i=e.device_id;return i?`sensor.petkit_feeder_${i}_${t}`:e.entity||""}(this._config,e):""}static getStubConfig(){return{device_id:"",show_timeline:!0,show_summary:!0,show_actions:!0}}static getConfigElement(){return document.createElement("petkit-feeder-card-editor")}setConfig(e){if(!e.device_id&&!e.entity)throw new Error(Pe("error.device_or_entity_required"));this._config={...e,show_timeline:e.show_timeline??!0,show_summary:e.show_summary??!0,show_actions:e.show_actions??!0}}shouldUpdate(){return!0}updated(){if(this._pendingFocus){const{itemId:e,field:t}=this._pendingFocus,i=`edit-${t}-${e}`,s=this.shadowRoot?.getElementById(i);s&&(s.focus(),"name"===t?s.select():"time"===t&&s.showPicker?.()),this._isAddingNewPlan=!1,this._pendingFocus=null}}render(){if(!this._config||!this.hass)return B`<div>${this._localize("common.loading")}</div>`;const e=this._config.entity||this._getEntityId("feeding_schedule"),t=this._config.history_entity||this._getEntityId("feeding_records"),i=this.hass.states[e],s=t?this.hass.states[t]:null;if(!i)return B`
      ...
      `;const n=(a=this._config).connectivity_entity||`binary_sensor.petkit_feeder_${a.device_id}_online`;var a;const o=this.hass.states[n],r="on"===o?.state,l=ve(i.attributes,s?.attributes||{},r);this._weeklyCache.originData||(this._weeklyCache.initOrigin(l),this._selectedDay=ge());const d=this._weeklyCache.getDayCache(this._selectedDay),c=d?.timeline||[],h=d?.summary||this._emptySummary();let m=this._config.name;if(!m){const e=this._config.device_name_entity||this._getEntityId("device_name"),t=this.hass.states[e];m=t?.state}return m||(m=i.attributes.friendly_name||this._localize("default.device_name")),B`
    ...
    `}_emptySummary(){return{planAmount:0,actualAmount:0,manualAmount:0,isOnline:!1,totalCount:0,completedCount:0,pendingCount:0}}_renderWeekdayTabs(){const e=ge();return B`
    ...
    `}_handleDaySwitch(e){this._selectedDay!==e&&(this._selectedDay=e,this._cancelEdit(),this.requestUpdate())}_getDateDisplay(){const e=new Date,t=e.getDay(),i=0===t?7:t,s=this._selectedDay-i,n=new Date(e);n.setDate(e.getDate()+s);const a=n.getMonth()+1,o=n.getDate(),r=this._localize(`weekday.${this._selectedDay}`);return this._localize("date.format",{month:a,day:o,weekday:r})}_renderTimeline(e){return e.length?B`
      <div class="section">
    ...
    `,n=ge(),a=this._selectedDay===n;let o=!1;if(this._selectedDay<n)o=!0;else if(a&&e.time){const t=new Date,i=60*t.getHours()+t.getMinutes(),[s,n]=e.time.split(":").map(Number);o=60*s+n<i}const r="plan"===e.itemType&&e.canDisable&&!o,l="plan"===e.itemType&&e.canDelete,d="plan"===e.itemType,c="time"===t&&this._editingItem?B`
          <input 
        ...
        `:B`<span class="time ${d?"editable":""}" @click=${d?()=>this._startEdit(e,"time"):void 0}>${e.time}</span>`,h="name"===t&&this._editingItem?B`
          ...
          />
        `:B`<span class="name ${d?"editable":""}" @click=${d?()=>this._startEdit(e,"name"):void 0}>${e.name}</span>`,m=void 0!==e.actualAmount?e.actualAmount:e.plannedAmount,u="amount"===t&&this._editingItem?B`
          <input 
            ...
            @keydown=${e=>{"Escape"===e.key&&this._cancelEdit()}}
          />
        `:B`<span class="amount ${d?"editable":""}" @click=${d?()=>this._startEdit(e,"amount"):void 0}>${m}g</span>`;return B`
          ...
          <div class="item-actions">
            ${this._config?.show_actions?B`
                  <div 
                    ...
                    title="${this._getToggleTitle(e,o)}"
                  >
  ...
  ${Ee}
  ${De}
`)();_localize(e,t){return Pe(e,ze(this.hass),t)}_getToggleTitle(e,t){return"deleted_plan"===e.itemType?this._localize("status.deleted"):t?this._localize("status.expired"):e.isExecuted?this._localize("status.executed"):e.isEnabled?this._localize("status.click_disable"):this._localize("status.click_enable")}};e([pe({attribute:!1})],Ue.prototype,"hass",void 0),e([pe({attribute:!1})],Ue.prototype,"_config",void 0),Ue=e([he("petkit-feeder-card")],Ue),customElements.get("petkit-feeder-card")||customElements.define("petkit-feeder-card",Ue);let Oe=class extends de{hass;config;_schema=[{name:"device_id",required:!1,selector:{text:{}},label:"editor.device_id"},{name:"entity",required:!1,selector:{entity:{domain:["sensor"]}},label:"editor.entity"},{name:"history_entity",required:!1,selector:{entity:{domain:["sensor"]}},label:"editor.history_entity"},{name:"name",selector:{text:{}},label:"editor.card_title"},{type:"grid",name:"",title:"editor.display_control",schema:[{name:"show_timeline",selector:{boolean:{}},label:"editor.show_timeline"},{name:"show_summary",selector:{boolean:{}},label:"editor.show_summary"},{name:"show_actions",selector:{boolean:{}},label:"editor.show_actions"}]}];render(){return this.hass&&this.config?B`
      <ha-form
        .hass=${this.hass}
        .data=${this.config}
        .schema=${this._schema}
      ...
      ></ha-form>
    `:B`<div>${this._localize("common.loading_editor")}</div>`}_computeLabel=e=>this._localize(e.name||e.label||e.title);_valueChanged(e){const t=e.detail.value;this.config=t;const i=new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0});this.dispatchEvent(i)}_localize(e){return Pe(e,ze(this.hass||{}))}static get styles(){return o`
      :host {
        display: block;
      }
      ha-form {
    ...
    `}};e([pe()],Oe.prototype,"hass",void 0),e([pe()],Oe.prototype,"config",void 0),Oe=e([he("petkit-feeder-card-editor")],Oe),customElements.get("petkit-feeder-card-editor")||customElements.define("petkit-feeder-card-editor",Oe),window.customCards=window.customCards||[],window.customCards.push({type:"petkit-feeder-card",name:"小佩喂食器",description:"显示小佩喂食器状态、喂食计划和历史记录",preview:!0,documentationURL:"https://github.com/ningjx/petkit-feeder-card"});export{Ue as PetkitFeederCard,Oe as PetkitFeederCardEditor};
